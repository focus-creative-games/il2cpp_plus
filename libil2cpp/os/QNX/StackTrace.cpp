...
namespace
{
    ...
    struct QNXStackTrace
    {
        ...
        static _Unwind_Reason_Code Callback(struct _Unwind_Context* context, void* self)
        {
            ...
            if (static_cast<QNXStackTrace*>(self)->PushStackFrameAddress(addr))
    ...
    {
        QNXStackTrace callstack = {};
        _Unwind_Backtrace(QNXStackTrace::Callback, &callstack);
